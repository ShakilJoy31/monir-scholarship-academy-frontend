        ...
        children: [
          {
            ...
            link: "/branch-admin/pages/therapy-types",
            roles: ["branch-admin"],
          },
          {
            text: "Therapists",
            icon: <MdOutlineMedicalServices className="text-2xl" />,
            link: "/branch-admin/pages/therapists",
            roles: ["branch-admin"],
          },
          {
            text: "Student-Therapist Assignment",
            icon: <FaUserPlus className="text-2xl" />,
            link: "/branch-admin/pages/student-therapist-assignment",
            roles: ["branch-admin"],
          },
          {
            text: "Therapy Rooms",
            icon: <GiMeditation className="text-2xl" />,
            link: "/branch-admin/pages/therapy-rooms",
            roles: ["branch-admin"],
          },
        ],
      },
      {
        text: "Therapy Scheduling",
        icon: <BiCalendarCheck className="text-2xl" />,
        link: "#",
        roles: ["branch-admin"],
        children: [
          {
            ...
            icon: <BiCalendarCheck className="text-2xl" />,
            link: "/branch-admin/pages/therapy-session-scheduling",
            roles: ["branch-admin"],
          },
          {
            text: "Therapist Daily Schedule",
            icon: <BiTimeFive className="text-2xl" />,
            link: "/branch-admin/pages/therapist-daily-schedule",
            roles: ["branch-admin"],
          },
          {
            text: "Weekly Schedule Templates",
            icon: <AiOutlineCalendar className="text-2xl" />,
            link: "/branch-admin/pages/weekly-schedule-templates",
            roles: ["branch-admin"],
          },
          {
            text: "Conflict Detection",
            icon: <MdOutlineHealthAndSafety className="text-2xl" />,
            link: "/branch-admin/pages/conflict-detection",
            roles: ["branch-admin"],
          },
          {
            text: "Makeup & Rescheduled Sessions",
            icon: <AiOutlineSwap className="text-2xl" />,
            link: "/branch-admin/pages/makeup-rescheduled-sessions",
            roles: ["branch-admin"],
          },
        ],
      },
      {
        text: "Therapy Records & Reports",
        icon: <MdOutlineAssignment className="text-2xl" />,
        link: "#",
        roles: ["branch-admin"],
        children: [
          {
            text: "Therapy Attendance",
            icon: <FaUserClock className="text-2xl" />,
            link: "/branch-admin/pages/therapy-attendance",
            roles: ["branch-admin"],
          },
          {
            text: "Session Cancellations",
            icon: <GiHeartPlus className="text-2xl" />,
            link: "/branch-admin/pages/session-cancellations",
            roles: ["branch-admin"],
          },
          {
            text: "Student Therapy History",
            icon: <MdOutlineTimeline className="text-2xl" />,
            link: "/branch-admin/pages/student-therapy-history",
            roles: ["branch-admin"],
          },
          {
            text: "Session Notes",
            icon: <MdOutlineNoteAlt className="text-2xl" />,
            link: "/branch-admin/pages/session-notes",
            roles: ["branch-admin"],
          },
          {
            text: "Therapy Goals & Progress",
            icon: <MdOutlineAssignment className="text-2xl" />,
            link: "/branch-admin/pages/therapy-goals-progress",
            roles: ["branch-admin"],
          },
          {
            text: "Progress Reports",
            icon: <GiBrain className="text-2xl" />,
            link: "/branch-admin/pages/progress-reports",
            roles: ["branch-admin"],
          },
        ],
      },
        ...
        children: [
          {
            text: "Staff Profile",
            icon: <FaUserTie className="text-2xl" />,
            link: "/branch-admin/pages/staff-profile",
            roles: ["branch-admin"],
          },
          {
            text: "Employee ID",
            icon: <BiSolidIdCard className="text-2xl" />,
            link: "/branch-admin/pages/employee-id",
            roles: ["branch-admin"],
          },
          {
            text: "Departments & Designations",
            icon: <FaIdBadge className="text-2xl" />,
            link: "/branch-admin/pages/departments-designations",
            roles: ["branch-admin"],
          },
          {
            text: "Qualification",
            icon: <GraduationCap className="text-2xl" />,
            link: "/branch-admin/pages/qualification",
            roles: ["branch-admin"],
          },
          {
            text: "Joining Date",
            icon: <AiOutlineCalendar className="text-2xl" />,
            link: "/branch-admin/pages/joining-date",
            roles: ["branch-admin"],
          },
          {
            text: "Training Records",
            icon: <School className="text-2xl" />,
            link: "/branch-admin/pages/training-records",
            roles: ["branch-admin"],
          },
          {
            text: "Staff Attendance",
            icon: <FaUserClock className="text-2xl" />,
            link: "/branch-admin/pages/staff-attendance",
            roles: ["branch-admin"],
          },
          {
            text: "Leave Management",
            icon: <AiOutlineCalendar className="text-2xl" />,
            link: "/branch-admin/pages/leave-management",
            roles: ["branch-admin"],
          },
          {
            text: "Staff Documents",
            icon: <FileText className="text-2xl" />,
            link: "/branch-admin/pages/staff-documents",
            roles: ["branch-admin"],
          },
          {
            text: "Employment Status",
            icon: <MdBadge className="text-2xl" />,
            link: "/branch-admin/pages/employment-status",
            roles: ["branch-admin"],
          },
        ],
      },
