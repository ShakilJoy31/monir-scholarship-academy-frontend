...
import { useGetUnpaidClassFeeQuery } from "@/app/store/api/allReport/allReportApi";
import ReusableTable from "@/components/shared/reusable-component/ReusableTable";
import PaginationComponent from "@/components/shared/reusable-component/PaginationComponent";
import ViewSingleUnpaidClassFeeReport from "./ViewSingleUnpaidClassFeeReport"; // Import the modal
...
const UnpaidClassFeeReport = () => {
  ...
  const {
    ...
    isError,
    refetch,
  } = useGetUnpaidClassFeeQuery(selectedClassId, {
  ...
  const handlePrint = () => {
    ...
    printData(selectedData, printColumns, "Unpaid Class Fee Report");
  };
  ...
  const handlePDF = async () => {
    ...
    await generatePDF(
      selectedData,
      pdfColumns,
      "Unpaid Class Fee Report",
      "Unpaid_class_fee_report"
    );
  };
    ...
    <Box>
      ...
      <Box sx={{ mb: 3 }}>
        ...
        <Typography variant="body1" color="textSecondary">
          View and manage unpaid class fees for students
        </Typography>
      </Box>
      ...
      <ViewSingleUnpaidClassFeeReport
        open={modalOpen}
...
export default UnpaidClassFeeReport;
