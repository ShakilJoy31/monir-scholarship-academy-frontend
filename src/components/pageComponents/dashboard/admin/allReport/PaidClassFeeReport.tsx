...
import { useGetPaidClassFeeQuery } from "@/app/store/api/allReport/allReportApi";
import ReusableTable from "@/components/shared/reusable-component/ReusableTable";
import PaginationComponent from "@/components/shared/reusable-component/PaginationComponent";
import ViewSinglePaidClassFeeReport from "./ViewSinglePaidClassFeeReport";
...
const PaidClassFeeReport = () => {
  ...
  const {
    ...
    isError,
    refetch,
  } = useGetPaidClassFeeQuery(selectedClassId, {
  ...
  const handlePDF = async () => {
    ...
    await generatePDF(selectedData, pdfColumns, 'Paid Class Fee Report', 'paid_class_fee_report');
  };
    ...
    <Box>
      ...
      <Box sx={{ mb: 3 }}>
        ...
        <Typography variant="body1" color="textSecondary">
          View and manage paid class fees for students
        </Typography>
      </Box>
...
export default PaidClassFeeReport;