...
import { useGetPaidTeacherFeeQuery } from "@/app/store/api/allReport/allReportApi";
import ReusableTable from "@/components/shared/reusable-component/ReusableTable";
import PaginationComponent from "@/components/shared/reusable-component/PaginationComponent";
import ViewSinglePaidTeacherFeeReport from "./ViewSinglePaidTeacherFeeReport";
...
const PaidTeacherFeeReport = () => {
  ...
  const handleCloseModal = () => {
    ...
    const handlePrint = () => {
      ...
      printData(selectedData, printColumns, "Paid Teacher Salary Report");
    };
    ...
    const handlePDF = async () => {
      ...
      await generatePDF(
        selectedData,
        pdfColumns,
        "Paid Teacher Salary Report",
        "paid_teacher_salary_report"
      );
    };
    ...
    <Box>
      ...
      <Box sx={{ mb: 3 }}>
        ...
        <Typography variant="body1" color="textSecondary">
          View and manage paid teacher salary for teachers
        </Typography>
      </Box>
      ...
      <ViewSinglePaidTeacherFeeReport
        open={modalOpen}
...
export default PaidTeacherFeeReport;