...
import { useGetPaidExamFeesByStudentIdQuery } from "@/app/store/api/exams/examFeeDiscountApi";
...
const StudentPaidExamFees = () => {
  ...
  const {
    ...
    isLoading,
    isError,
  } = useGetPaidExamFeesByStudentIdQuery(studentId, {
    skip: !studentId,
  });
  ...
  const columns = [
    ...
    },
    {
      key: "examName",
      header: "Exam",
       render: (row: UnpaidExamFee) => `${row.exam?.name || 0}`,
    },
   
    {
    ...
    },
     {
      ...
      header: "Discount Type",
       render: (row: UnpaidExamFee) => `${row.discountType || 0}`,
    },
     {
      key: "discount",
      header: "Discount",
...
export default StudentPaidExamFees;