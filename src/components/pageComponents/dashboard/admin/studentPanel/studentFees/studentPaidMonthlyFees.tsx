...
import { useGetPaidClassFeeAssignsByTeacherQuery } from "@/app/store/api/classes/classFeeApi";
...
const StudentPaidMonthlyFees = () => {
 ...
 const {
  ...
  isLoading,
  isError,
} = useGetPaidClassFeeAssignsByTeacherQuery(studentId || 0, { skip: !studentId });
  ...
  const columns = [
    ...
    },
    {
      key: "classFee",
      header: "Class Fee",
      render: (row: ClassFeeAssign) => `BDT ${row.classFee}`,
    },
    {
      key: "discount",
      header: "Discount",
    ...
    },
    {
      key: "netPayable",
      header: "Net Payable",
      render: (row: ClassFeeAssign) => `BDT ${row.netPayable}`,
    },
    {
      key: "paidAt",
      header: "Paid Date",
      render: (row: ClassFeeAssign) =>
        row.paidAt ? new Date(row.paidAt).toLocaleDateString() : "N/A",
    },
    {
      key: "actions",
      header: "Actions",
...
export default StudentPaidMonthlyFees;