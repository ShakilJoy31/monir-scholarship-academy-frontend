...
import { useGetPaidHostelFeeQuery } from "@/app/store/api/allReport/allReportApi";
...
import ViewSinglePaidHostelFeeReport from "./ViewSinglePaidHostelFeeReport";
...
const PaidHostelFeeReport = () => {
  ...
  const {
    ...
    isError,
    refetch,
  } = useGetPaidHostelFeeQuery(selectedClassId, {
  ...
  const handleCloseModal = () => {
    ...
    const handlePrint = () => {
      ...
      printData(selectedData, printColumns, "Paid Hostel Fee Report");
    };
    ...
    const handlePDF = async () => {
      ...
      await generatePDF(
        selectedData,
        pdfColumns,
        "Paid Hostel Fee Report",
        "paid_hostel_fee_report"
      );
    };
    ...
    <Box>
      ...
      <Box sx={{ mb: 3 }}>
        ...
        <Typography variant="body1" color="textSecondary">
          View and manage paid hostel fees for students
        </Typography>
      </Box>
      ...
      <Paper>
        {isLoading ? (
          ...
          <Typography
            ...
            sx={{ p: 4, textAlign: "center" }}
          >
            No paid fees found for the selected hostel
          </Typography>
        ) : (
          <>
...
export default PaidHostelFeeReport;