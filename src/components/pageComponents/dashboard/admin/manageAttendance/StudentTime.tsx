...
import { useDeleteStudentTimeMutation, useGetAllStudentTimeQuery, } from "@/app/store/api/attendance/attendanceApi";
import AddStudentsTime from "./AddStudentsTime";
import EditStudentTime from "./EditStudentTime";
...
const StudentTime = () => {
    ...
    const [deleteStudentTime] = useDeleteStudentTimeMutation();
    ...
    const handleDeleteTime = async () => {
        handleDeleteConfirmation(
            async (id: number) => {
                await deleteStudentTime(id).unwrap();
            },
            {
        ...
        <Box>
            ...
            <AnimatePresence>
                {addTimeModalOpen && (
                    ...
                    >
                        <AddStudentsTime handleCloseAddTimeModal={handleCloseAddTimeModal} />
                    </Modal>
                )}
            </AnimatePresence>
            ...
            <AnimatePresence>
                {editTimeModalOpen && (
                    ...
                    >
                        <EditStudentTime handleCloseEditTimeModal={handleCloseEditTimeModal} timeForEdit={timeForEdit} />
                    </Modal>
                )}
            </AnimatePresence>
