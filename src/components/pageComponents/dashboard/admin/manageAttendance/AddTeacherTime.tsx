...
const AddTeachersTime = ({ handleCloseAddTimeModal }) => {
    // states start **************************************************
                                    ...
                                    <div className="flex items-start gap-4">
                                        <div className="flex gap-4 items-start w-[calc(100%-64px)]">
                                            ...
                                            <FormControl fullWidth size="small" className="flex-1/4">
                                                <MuiMultiSelect
                                                    options={
                                                        teachersData?.data
                                                            ?.filter((teacher) => !addedTimes?.find((item) => item?.id === teacher?.id)) // keep only not added
                                                            ?.map((teacher) => ({ id: teacher?.id, label: teacher?.name }))              // then map to options
                                                    }
                                        ...
                                        <div className="">
                                            <Button
                                                ...
                                                disabled={!filters?.inTime || !filters?.outTime || !filters?.maxDelay || !filters?.maxEarly || !filters?.selectedTeachersIds?.length}
...
export default AddTeachersTime;