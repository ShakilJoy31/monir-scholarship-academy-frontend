...
import { Dayjs } from "dayjs";
import { useUpdateStudentTimeMutation } from "@/app/store/api/attendance/attendanceApi";
...
const EditStudentTime = ({ handleCloseEditTimeModal, timeForEdit }) => {
    // states start **************************************************
    ...
    // api (redux) start ************************
    const [updateStudentTime] = useUpdateStudentTimeMutation();
    // api (redux) end ************************
    ...
    const handleUpdateTime = async () => {
        ...
        try {
            await updateStudentTime(arrayOfItems).unwrap();
...
export default EditStudentTime;