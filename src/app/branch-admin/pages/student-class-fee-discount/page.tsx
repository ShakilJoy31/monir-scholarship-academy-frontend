...
import AddEditClassFeeDiscount from "@/components/pageComponents/dashboard/admin/classList/AddEditClassFeeDiscount";
...
const StudentClassFeeDiscount = () => {
  ...
  return (
    <Box>
      <PageHeader
        title="Monthly Fee Discounts"
        buttonText="Add Discount"
        buttonIcon={<Plus size={20} />}
        onButtonClick={() => handleOpenModal()}
      />

      <AddEditClassFeeDiscount
        open={modalOpen}
        ...
        title={
          currentDiscount?.id
            ? "Edit Class Fee Discount"
            : "Add Class Fee Discount"
        }
      />
...
export default StudentClassFeeDiscount;
