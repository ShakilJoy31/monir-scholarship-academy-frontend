...
import { useSchoolChangePasswordMutation } from '@/app/store/api/branch/branchApi';
...
const user = useAppSelector((state) => state.auth.user);
  ...
  const { displayName, } = roleConfig[userRole] || roleConfig['school-admin'];

  // RTK Query mutation hook
  const [schoolChangePassword, { isLoading }] = useSchoolChangePasswordMutation();
